...
public class SucbjectWithMarksChildAdapter extends RecyclerView.Adapter<SucbjectWithMarksChildAdapter.ViewHolder> {

    private Context context;
    private List<SubjectModel> subjectList;
    private int maxMarks; // Max marks for that class

    public SucbjectWithMarksChildAdapter(Context context, List<SubjectModel> subjectList, int maxMarks) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        setupPieChart(holder.pieChart, subject.getMarks(), maxMarks);
    }
    ...
    private void setupPieChart(PieChart pieChart, int totalMarks, int maxMarks) {
        ...
        // Set totalMarks (first part) in blue
