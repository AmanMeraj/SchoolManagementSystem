...
import com.school.schoolmanagement.databinding.RowEmployeePasswordBinding;
import com.school.schoolmanagement.databinding.RowStudnetPasswordBinding;

import java.util.List;

public class AdapterEmployeePassword extends RecyclerView.Adapter<AdapterEmployeePassword.ViewHolder> {
    private final Context context;
    private final List<StudentPassword> userList;

    public AdapterEmployeePassword(Context context, List<StudentPassword> userList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RowEmployeePasswordBinding binding = RowEmployeePasswordBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.tvRole.setText(user.getClassName());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        private final RowEmployeePasswordBinding binding;
        private boolean isPasswordVisible = false; // Track visibility state

        public ViewHolder(RowEmployeePasswordBinding binding) {
