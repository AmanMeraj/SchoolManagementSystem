package com.school.schoolmanagement.Teachers.Timetable;
...
import com.school.schoolmanagement.databinding.ActivityTeachersTimetableBinding;

import java.util.ArrayList;
import java.util.List;

public class ActivityTeachersTimetable extends AppCompatActivity {
ActivityTeachersTimetableBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityTeachersTimetableBinding.inflate(getLayoutInflater());
