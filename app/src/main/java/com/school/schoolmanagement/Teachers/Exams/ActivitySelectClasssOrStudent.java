...
import com.school.schoolmanagement.databinding.ActivitySelectClasssOrStudentBinding;

import java.util.ArrayList;

public class ActivitySelectClasssOrStudent extends AppCompatActivity {
ActivitySelectClasssOrStudentBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivitySelectClasssOrStudentBinding.inflate(getLayoutInflater());
    ...
    private void setupSearchButton() {
        binding.btnSearch.setOnClickListener(v -> {
            ...
            if (!isWholeClassMode) {
                ...
                Intent intent = new Intent(ActivitySelectClasssOrStudent.this,ActivityTeachersInsertMarks.class);
